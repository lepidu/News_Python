# -*- coding: utf-8 -*-
"""
Created on Fri Jul  9 11:33:21 2021
...
clear = Button (keyboard, text="clear",command = clear, padx=58, pady=30)
clear.grid(row=3,  column=1, columnspan = 2)

plus = Button (keyboard, text="+",command = add, padx=30, pady=30)
plus.grid(row=4, column=0)

equals = Button (keyboard, text="=",command = result,padx=68, pady=30)
